    ...
    return (
        <div className="container py-12 px-6 mx-auto">
            <div className="max-w-lg mx-auto shadow px-6 py-7 rounded overflow-hidden">
                <h2 className="text-2xl uppercase font-medium mb-1 text-gray-700">Sign Up</h2>
                ...
                <form>
                    ...
                    <div className="mt-4">
                        <button
                            type="submit"
                            className="block w-full py-2 text-center text-white border border-teal-500   rounded hover:bg-transparent hover:text-teal-500 transition uppercase font-roboto font-medium tracking-wide text-sm text-[#458ff6] focus:outline-none focus:ring-0 focus:border-teal-500 bg-red-500"
